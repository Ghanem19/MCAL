...
#define TCCR1		(*(reg_type16)(0x4F))
#define TCNT1H		(*(reg_type8)())
#define TCNT1L		(*(reg_type8)())
#define TCNT1		(*(reg_type16)())
#define OCR1AH		(*(reg_type8)())
#define OCR1AL		(*(reg_type8)())
#define OCR1A		(*(reg_type16)())
#define OCR1BH		(*(reg_type8)())
#define OCR1BL		(*(reg_type8)())
#define OCR1B		(*(reg_type16)())
#define ICR1H		(*(reg_type8)())
#define ICR1L		(*(reg_type8)())
#define ICR1		(*(reg_type16)())
*/
 ...
 */
 /*
#define TCCR2		(*(reg_type8*)())
#define TCNT2		(*(reg_type8*)())
#define OCR2		(*(reg_type8*)())
*/
